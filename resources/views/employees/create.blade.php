      ...
      <div class="col-md-12">
          <div class="card">
              <div class="card-body">
                  ...
                  <form class="needs-validation" method="post" action="{{ route('employee.store') }}" enctype="multipart/form-data" data-parsley-validate novalidate>
                    <div class="form-group row {{ $errors->has('name') ? ' has-error' : '' }}">
                        <label for="name" class="col-sm-3 text-right control-label col-form-label">Employee Name</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Enter Employee Name" value="{{ Request::old('name') ?: '' }}" required>
                            @if ($errors->has('name'))
                    ...
                    <div class="form-group row {{ $errors->has('description') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="description" name="description" placeholder="Enter Employee Description" required>{{ Request::old('description') ?: '' }}</textarea>
                    ...
                    <div class="form-group m-b-0">
                      <div class="offset-sm-3 col-sm-9">
                          ...
                          <button type="submit" class="btn btn-info waves-effect waves-light m-t-10">Save Employee</button>
